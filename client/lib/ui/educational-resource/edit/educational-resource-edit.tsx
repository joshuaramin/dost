...
import { EducationalResourceInterface, EducationCategoryResult } from '@/lib/interface/education-resource/educational-resources.interface';
...
export default function EducationalResourceEdit({ id}: Props) {
    ...
    const { data } = useFormQuery<EducationalResourceInterface>({
    ...
    return (
    <Template
        title="Update Educational Resources"
    >   
