...
export type ActivityLogWhereInput = {
  ...
  user_id?: Prisma.StringNullableFilter<"ActivityLog"> | string | null
...
export type ActivityLogScalarWhereWithAggregatesInput = {
  ...
  user_id?: Prisma.StringNullableWithAggregatesFilter<"ActivityLog"> | string | null
}
...
export interface ActivityLogDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `activity_logs_id`
   * const activityLogWithActivity_logs_idOnly = await prisma.activityLog.findMany({ select: { activity_logs_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ActivityLogs and only return the `activity_logs_id`
   * const activityLogWithActivity_logs_idOnly = await prisma.activityLog.createManyAndReturn({
   *   select: { activity_logs_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   * })
   ...
   * })
   * 
   * // Update zero or more ActivityLogs and only return the `activity_logs_id`
   * const activityLogWithActivity_logs_idOnly = await prisma.activityLog.updateManyAndReturn({
   *   select: { activity_logs_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ActivityLogFieldRefs {
  ...
  readonly user_id: Prisma.FieldRef<"ActivityLog", 'String'>
}
